...
typedef struct str_gdt_descriptor {
  uint16_t gdt_length;      // Tamaño de la GDT
  uint32_t gdt_addr;        // Dirección donde arranca 
...
extern gdt_entry_t gdt[];           // La tabla
extern gdt_descriptor_t GDT_DESC;   // Descriptor de la tabla
