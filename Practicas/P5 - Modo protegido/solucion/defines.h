...
#define GDT_CODE_0_SEL (uint16_t)(GDT_IDX_CODE_0 << 3)
#define GDT_DATA_0_SEL (uint16_t)(GDT_IDX_DATA_0 << 3)
#define GDT_CODE_3_SEL (uint16_t)((GDT_IDX_CODE_3 << 3) | 3)
#define GDT_DATA_3_SEL (uint16_t)((GDT_IDX_DATA_3 << 3) | 3)
...
#define DESC_TYPE_EXECUTE_READ  0xA // 0b1010
#define DESC_TYPE_READ_WRITE    0x2 // 0b0010
